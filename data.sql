...
insert into people values (NULL,"00128","admin", "Zhang", 10, NULL);
insert into people values (NULL,"12345","admin", "Shankar", 11, NULL);
insert into people values (NULL,"19991","admin", "Brandt", 12, NULL);
insert into people values (NULL,"23121","admin", "Chavez", 13, NULL);
insert into people values (NULL,"44553","admin", "Peltier", 14, NULL);
insert into people values (NULL,"45678","admin", "Levy", 15, NULL);
insert into people values (NULL,"54321","admin", "Williams", 16, NULL);
insert into people values (NULL,"55739","admin", "Sanchez", 17, NULL);
insert into people values (NULL,"70557","admin", "Snow", 18, NULL);
insert into people values (NULL,"76543","admin", "Brown", 19, NULL);
insert into people values (NULL,"76653","admin", "Aoi", 20, NULL);
insert into people values (NULL,"98765","admin", "Bourikas", 21, NULL);
insert into people values (NULL,"98988","admin", "Tanaka", 22, NULL);

insert into people values(NULL,"10101","admin", "Srinivasan",NULL ,1);
insert into people values(NULL,"12121","admin", "Wu",NULL ,2);
insert into people values(NULL,"15151","admin", "Mozart",NULL ,3);
insert into people values(NULL,"22222","admin", "Einstein",NULL ,4);
insert into people values(NULL,"32343","admin", "El Said",NULL ,5);
insert into people values(NULL,"33456","admin", "Gold",NULL ,6);
insert into people values(NULL,"45565","admin", "Katz",NULL ,7);
insert into people values(NULL,"58583","admin", "Califieri",NULL ,8);
insert into people values(NULL,"76543","admin", "Singh",NULL ,9);
insert into people values(NULL,"76766","admin", "Crick",NULL ,10);
insert into people values(NULL,"83821","admin", "Brandt",NULL ,11);
insert into people values(NULL,"98345","admin", "Kim",NULL ,12);
